...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* Because the nestedFunction is inside myFunction, it is part of the function scope, giving it access to all variables inside the function. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(animals){
    const lowerCaseNames = animals.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const animalFilter = data.filter(function(item){
  ...
  */
  ...
  function USApop(data){
    const populationRed = data.reduce(function(acc, item){
